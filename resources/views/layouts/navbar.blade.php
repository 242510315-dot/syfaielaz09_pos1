        ...
        <div class="navbar-top-row">
            ...
            >
                ...
                <ul class="navbar-nav menu-cute">
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link {{ Request::is('jenis-produk') || Request::is('jenis-produk/*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link {{ Request::is('produk') || Request::is('produk/*') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a
                            class="nav-link {{ Request::is('penjualan') || Request::is('penjualan/*') ? 'active' : '' }}"
