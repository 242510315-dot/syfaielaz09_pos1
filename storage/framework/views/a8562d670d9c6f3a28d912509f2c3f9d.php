...
<?php $__env->startSection('title', 'Beranda VeggieGo'); ?>
    ...
    <section class="beranda-hero">
        <div class="beranda-hero-content">
            ...
            <div class="beranda-actions">
                ...
                <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-outline-light">
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="beranda-card">
                    ...
                    <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-outline-success btn-sm">
            ...
            <div class="col-md-4">
                <div class="beranda-card">
                    ...
                    <a href="<?php echo e(route('penjualan.index')); ?>" class="btn btn-outline-success btn-sm">
            ...
            <div class="col-md-4">
                <div class="beranda-card">
                    ...
                    <a href="<?php echo e(route('tentang-aplikasi')); ?>" class="btn btn-outline-success btn-sm">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\syfaielaz09_pos1\resources\views/beranda/index.blade.php ENDPATH**/ ?>