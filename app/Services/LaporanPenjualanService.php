...
class LaporanPenjualanService
{
     ...
     */
    public function ringkasanHarian(): array
    {
        $data = DB::table('penjualan')
            ...
            ->selectRaw('
                ...
                SUM(CASE WHEN metode_pembayaran IN ("TUNAI", "CASH") THEN total_pembayaran ELSE 0 END) as total_cash,
                SUM(CASE WHEN metode_pembayaran NOT IN ("TUNAI", "CASH") THEN total_pembayaran ELSE 0 END) as total_non_tunai
            ')
            ->first();
