...
class PenjualanController extends Controller
{
    ...
    public function update(Request $request, Penjualan $penjualan)
    {
        ...
        if ($request->payment_method === 'TUNAI') {
            ...
            // Uang customer harus mencukupi
            if ($uangDibayar < $total) {
                return back()
                    ->withInput()
                    ->with(
                        'errors',
                        'Uang yang dibayar kurang dari total transaksi.'
                    );
            }
        ...
        // ================= QRIS =================
            ...
            // QRIS dianggap dibayar sesuai total
            $uangDibayar = $total;
            $kembalian = 0;
        }
        ...
        // Setelah checkout kembali ke halaman Penjualan
        return redirect()
